...
Example: `NIFTY50_technical_analysis_2026-03-12.md`
...
- Provide specific price levels for support, resistance, and targets (in ₹)
...
```
User: "Please analyze this weekly chart of Nifty 50"
...
6. Saves as NIFTY50_technical_analysis_2026-03-12.md
```

**Example 2: Multiple Chart Analysis**
```
User: "Analyze these three charts: Reliance, HDFC Bank, and Bank Nifty"
...
```
User: "I'm particularly interested in whether TCS will break above resistance. Analyze the chart."
[Provides chart image]
...
- Volume analysis principles (including delivery volume context for Indian markets)
- Chart pattern recognition
- Scenario development and probability assignment framework
- Indian market specific considerations (circuit limits, F&O expiry effects)
